-- Fix session_id type mismatch in insert_training_registration function
-- The training_registrations.session_id field is TEXT, not UUID

DROP FUNCTION IF EXISTS insert_training_registration(UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, INTEGER, TEXT, TEXT);

-- Recreate the function with TEXT session_id parameter
